...
<body>
    ...
    <div class="content">
        <div>
        <h2>Dashboard</h2>
        <p>Selamat datang di Halaman Admin <b>Website Genteng Ganteng</b>.<br>
           Kamu bisa mengedit daftar genteng, profil, dan pesan dari pengguna. <br>
           Manfaatkan halaman admin dengan bijak karena Genteng Ganteng <br>
           dimulai dari sifat ganteng penggunanya.</P>
