...
<body>
    ...
    <footer style="background-color:#006380;">
        <p style="font-size: medium;"><b>Genteng Ganteng - </b> Jual Genteng Kualitas Super</p>
        <p style="font-size: small;">Copyright 2024 &copy; Genteng Ganteng All right reserved</p>
    </footer>
</body>
</html>